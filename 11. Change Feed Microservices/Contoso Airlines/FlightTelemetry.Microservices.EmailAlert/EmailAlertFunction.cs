...
namespace FlightTelemetry.Microservices.EmailAlert2
{
	public static class EmailAlertFunction
    {
        ...
        private static readonly SendGridClient _sendGridClient =
            new(Environment.GetEnvironmentVariable("SendGridApiKey"));
        ...
        public static async Task EmailAlert(
            [CosmosDBTrigger(
                ...
                LeaseContainerPrefix = "EmailAlert-"
            )]
        ...
        private static async Task CheckFlightLocation(JObject document, ILogger logger)
        {
